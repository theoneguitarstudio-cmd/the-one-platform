...
export function PublicHeader() {
  return <header className="public-header"><Link href="/" className="wordmark"><span className="brand-symbol" aria-hidden="true">♫</span>The One 2.0</Link><nav aria-label="主要導覽"><Link href="/#courses">系統課程</Link><Link href="/teachers">老師</Link><Link href="/#how-it-works">學習方式</Link><Link href="/#membership">會員方案</Link></nav><div className="header-actions"><Link href="/auth/sign-in">登入</Link><PrimaryCTA href="/student">開始學習</PrimaryCTA></div><details className="mobile-menu"><summary>選單 ☰</summary><nav aria-label="手機主要導覽"><Link href="/#courses">系統課程</Link><Link href="/teachers">老師</Link><Link href="/#how-it-works">學習方式</Link><Link href="/#membership">會員方案</Link><Link href="/auth/sign-in">登入</Link></nav></details></header>;
}
export function PageShell({ children }: { children: ReactNode }) {
  return <><PublicHeader /><main className="public-main">{children}</main><footer className="site-footer"><Link href="/" className="wordmark"><span className="brand-symbol" aria-hidden="true">♫</span>The One 2.0</Link><p>讓每一步練習，都更靠近喜歡的自己。</p><span>Learning, with direction.</span></footer></>;
}
