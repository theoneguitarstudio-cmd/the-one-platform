...
const vars = { THE_ONE_ENV: "preview", NEXT_PUBLIC_APP_ENV: "preview", NEXT_PUBLIC_DATA_MODE: "mock", NEXT_PUBLIC_SITE_URL: "https://the-one-platform-preview.theoneguitarstudio.workers.dev" };
