...
export const EXPECTED_MIGRATION = "20260904001100";
...
const SQL_TEMPLATE = path.join("supabase", "tests", "remote", "epic6_remote_smoke.sql");
...
export function validateTargetGate(options, linkedProjectRef) {
  ...
  if (!ALLOWED_ENVIRONMENTS.has(options.environment)) throw new Error("Environment must be staging, recovery, or production.");
